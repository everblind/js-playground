define(['asteroid', 'bullet', 'particle', 'pool', 'ship', 'vec2d'], function(Asteroid, Bullet, Particle, Pool, Ship, Vec2D)
{
	//common vars
	...
	function shipInit()
	{
		ship = Ship.create(screenWidth >> 1, screenHeight >> 1, {generateShot:generateShot, resetGame:resetGame});
	}
